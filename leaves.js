...
try {
 ...
 ── GET apileavesplanningyear = 2025 & month=6 ────────────────────────────
...
try {
 ...
 ── PATCH apileavesidapprove ─────────────────────────────────────────
 Approuver une demande(manageradmin uniquement)
router.patch('idapprove', requireRole('manager', 'admin'), [
...
res.json({ leave rows[0], message 'Demande approuvée.' });
 ...
 ── PATCH apileavesidreject ──────────────────────────────────────────
 Refuser une demande(manageradmin uniquement)
router.patch('idreject', requireRole('manager', 'admin'), [
